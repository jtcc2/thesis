...
This is a copy of code for the paper [Structural Results for Maximal Quaternion Orders and Connecting Ideals of Prime Power Norm in $B_{p,\infty}$](https://eprint.iacr.org/2025/033) which is also available [here](https://github.com/jtcc2/structural-results-for-quaternion-orders-and-ideals).
